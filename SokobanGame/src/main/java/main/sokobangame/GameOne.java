...
public class GameOne {
    ...
    private char[][] lvlOneMatrix = new char[ROW][COLUMN];
    ...
    private void chargeOriginalLevel(){
        ...
        for (int row = 0; row < ROW; row++) {
            for (int col = 0; col < COLUMN; col++) {
                lvlOneMatrix[row][col] = lvlMatrix[row][col].charAt(0);
            }
        }
    }
    ...
    private void chargeSavedLevel(){
        ...
        for (int row = 0; row < ROW; row++) {
            for (int col = 0; col < COLUMN; col++) {
                lvlOneMatrix[row][col] = strPlayerMatrix.charAt(index++);
            }
        }
    }
    ...
    private void updateLvlToCurMatrix(){
        for(int row = 0; row < ROW; row++){
            System.arraycopy(lvlOneMatrix[row], 0, curMatrix[row], 0, COLUMN);
        }
    }
    
    private void loadImages(){
        imageMap.put('#', "/imagesLvlOne/wall.jpg");
        imageMap.put('@', "/imagesLvlOne/player.jpg");
        imageMap.put('.', "/imagesLvlOne/floor.jpg");
        imageMap.put('o', "/imagesLvlOne/meat.jpg");
        imageMap.put('+', "/imagesLvlOne/oven.jpg");
        imageMap.put('0', "/imagesLvlOne/ovenAndMeat.jpg"); //Cuando una caja esta arriba de un punto
        imageMap.put('a', "/imagesLvlOne/playerAndOven.jpg"); //Cuando el jugador esta arriba de un punto
        imageMap.put(',', "/imagesLvlOne/dirt.jpg"); 
        
        //DECORATE:
        imageMap.put('1', "/imagesLvlOne/door.jpg"); 
        imageMap.put('2', "/imagesLvlOne/water.jpg"); 
        imageMap.put('3', "/imagesLvlOne/chicken.jpg"); 
        imageMap.put('4', "/imagesLvlOne/villager.jpg"); 
        imageMap.put('5', "/imagesLvlOne/chest.jpg"); 
        imageMap.put('6', "/imagesLvlOne/table.jpg"); 
        imageMap.put('7', "/imagesLvlOne/dog.jpg"); 
    }
    ...
    private void savePlayer(){
        ...
        pla.setPlaLevel("1"); //Depende del nivel
    ...
    private void playWalkingSound(){
        ...
        switch(randNumber){
            case 1:
                sound.loadSound("/sounds/walkingWoodSound1.wav");
                break;
            case 2:
                sound.loadSound("/sounds/walkingWoodSound2.wav");
                break;
            case 3:
                sound.loadSound("/sounds/walkingWoodSound3.wav");
                break;
            case 4:
                sound.loadSound("/sounds/walkingWoodSound4.wav");
                break;
            default:
                break;
        }
    ...
    private void playMusicSound(){
        music.loadSound("/sounds/levelOneMusic.wav");
        music.playSound();
    }
    ...
    private void playOvenSound(){
        ...
        sound.loadSound("/sounds/ovenSound.wav");
        
        if(curMatrix[4][7] == '0' && oven1 == false){
            sound.playSound();
            oven1 = true;
        }
        else if(curMatrix[4][7] != '0'){
            oven1 = false;
        }
        
        if(curMatrix[4][13] == '0' && oven2 == false){
            sound.playSound();
            oven2 = true;
        }
        else if(curMatrix[4][13] != '0'){
            oven2 = false;
        }
        
        if(curMatrix[6][15] == '0' && oven3 == false){
            sound.playSound();
            oven3 = true;
        }
        else if(curMatrix[6][15] != '0'){
            oven3 = false;
        }
    }
    
    private void playDogSound(){
        if(curMatrix[playerRow-1][playerCol] == '7'){
    ...
    private void playVillagerSound(){
        if(curMatrix[playerRow][playerCol-1] == '4' || curMatrix[playerRow+1][playerCol] == '4'){
            sound.loadSound("/sounds/villagerSound.wav");
            sound.playSound();
        }
    }
    
    private void alertMessage(){
        if(curMatrix[3][5] == 'o' || curMatrix[3][4] == 'o' || curMatrix[4][3] == 'o' || curMatrix[6][3] == 'o' || curMatrix[7][4] == 'o' || curMatrix[7][10] == 'o' || curMatrix[4][9] == 'o' || curMatrix[1][10] == 'o'){
